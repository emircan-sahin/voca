      ...
      <div className="mx-auto flex max-w-4xl flex-col items-center gap-6 sm:grid sm:grid-cols-3 sm:items-center sm:gap-0">
        ...
        <div className="flex flex-col items-center gap-4">
          <div className="flex items-center gap-6 text-sm text-neutral-500">
            <Link to="/terms" className="transition-colors hover:text-neutral-900">
              {t('footer.terms')}
            </Link>
            <Link to="/privacy" className="transition-colors hover:text-neutral-900">
              {t('footer.privacy')}
            </Link>
            <Link to="/refund" className="transition-colors hover:text-neutral-900">
              {t('footer.refund')}
            </Link>
          </div>
